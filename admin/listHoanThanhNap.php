    ...
    <div id="wrapper">
       ...
       <div class="container">
           <?php  ?>
            ...
            <div class="row" id="list-user">
                ...
                <div class="col-md-8">
                    ...
                    $sql = "SELECT COUNT(ID) as tong FROM `list_nap` where `trang_thai` = 2 ";
                    ...
                    //chia cho 30 mỗi page
                        ...
                        if(!isset($_POST["button_search"])){
                            ...
                            $sql_description = "SELECT * FROM list_nap where `trang_thai` = 2 ";
                        ...
                        if(isset($_POST["button_search"])){
                            $qry = isset($_POST["qry"]) ? $_POST["qry"] : '';
                            $sql_name = "SELECT * FROM list_nap WHERE id LIKE '%{$qry}%' and `trang_thai` = 2 ";
                            $sql_description = "SELECT * FROM list_nap WHERE id_user LIKE '%{$qry}%' and `trang_thai` = 2 ";
        ...
        <div id="phantrang" class="col-md-8">
                    ...
                    $vitri=$i*30;
                    ?>
                        <button type="submit" value=""><a href="listHoanThanhNap.php?vitri=<?php echo $vitri ?>">trang <?php echo $i; ?></a></button>
                        <?php 
                         }
                        ?>
                    </div>
