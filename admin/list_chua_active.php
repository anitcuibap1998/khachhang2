...
<body>
    <div id="wrapper">
        ...
        <div class="container">
            ...
            <div class="row" id="list-user">
                ...
                <div class="col-md-8">
                    ...
                    $sql = "SELECT COUNT(ID) as tong FROM `user`  where `active` = 0 ";
                    ...
                    //chia cho 30 mỗi page
                            ...
                            if(!isset($_POST["button_search"])){
                                ...
                                $sql = "SELECT * FROM user WHERE `username` LIKE '%$name%' and `active` = 0"." order by id  DESC limit $vitri,30";
                        ...
                        if(isset($_POST["button_search"])){
                            ...
                            $sql_name = "SELECT * FROM user WHERE `username` LIKE '%$name%' and `active` = 0";
                            $sql_description = "SELECT * FROM user WHERE email LIKE '%{$name}%' and `active` = 0";
        ...
        <div id="phantrang" class="col-md-8">
                    ...
                    $vitri=$i*30;
                    ?>
                        <button type="submit" value=""><a href="list_chua_active.php?vitri=<?php echo $vitri ?>">trang <?php echo $i; ?></a></button>
                        <?php 
                         }
                        ?>
                    </div>
