    ...
    <div id="wrapper">
       ...
       <div class="container">
           <?php  ?>
            ...
            <div class="row" id="list-user">
                ...
                <div class="col-md-8">
                    ...
                    if(isset($_GET['vitri'])){
                        $vitri=$_GET['vitri'];
                        $vitri = $vitri * $tong_so_hang;
                    }
                    //lấy tổng số hàng của user SELECT COUNT(ID) FROM `user`
                    $sql = "SELECT COUNT(ID) as tong FROM `san_pham`  where `hidden_sp` = 0  ";
                    ...
                    //chia cho 30 mỗi page
                        ...
                        if(!isset($_POST["button_search"])){
                            ...
                            $sql_description = "SELECT * FROM san_pham where `hidden_sp` = 0 ";
                            ...
                            if (mysqli_num_rows($result) > 0) { ?>
                                ...
                                <?php while($row = mysqli_fetch_assoc($result)) {  ?>
                                    <tr>
                                        ...
                                        <th> 
                                            <div class="hien__mota" ><a href="hienthi.php?id=<?php echo $row["id"] ?>"  target="_blank">Nội Dung Bị Ẩn</a></div>
                                           </th>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-danger" name="delete" onclick="del(this)">Ẩn Sản Phẩm</button>
                                        </td>
                                    </tr>
                                <?php 
                                }
                        ...
                        if(isset($_POST["button_search"])){
                            $qry = isset($_POST["qry"]) ? $_POST["qry"] : '';
                            $sql_name = "SELECT * FROM san_pham WHERE name LIKE '%{$qry}%' and `hidden_sp` = 0";
                            $sql_description = "SELECT * FROM san_pham WHERE id LIKE '%{$qry}%' and  `hidden_sp` = 0";
        ...
        <div id="phantrang" class="col-md-8">
                    ...
                    $vitri=$i*30;
                    ?>
                        <button type="submit" value=""><a href="manageSanPham.php?vitri=<?php echo $vitri ?>">trang <?php echo $i; ?></a></button>
                        <?php 
                         }
                        ?>
                    </div>
